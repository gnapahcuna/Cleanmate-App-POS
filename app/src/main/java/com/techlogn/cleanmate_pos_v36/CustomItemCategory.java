...
public class CustomItemCategory {
    ...
    public CustomItemCategory(String productID,String serviceTH,String serviceEN,String productTH, String productEN,String price,String img,String color,String serviceType,String num) {
