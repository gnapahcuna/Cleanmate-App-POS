...
public class MyAdapterCancelOrderdetailLevel1 extends ArrayAdapter {

    Fragment fragment;

    private Context mContext;
    private ArrayList<MyItemCancelOrderdetailLevel1> mArrayList;
    private int mLayout;
    ...
    public MyAdapterCancelOrderdetailLevel1(Context context, int layout, ArrayList<MyItemCancelOrderdetailLevel1> arrayList) {
