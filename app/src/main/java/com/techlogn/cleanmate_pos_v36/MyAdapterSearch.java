...
public class MyAdapterSearch extends ArrayAdapter {

    ViewHolderSearch vHolder;
    View v;
    Fragment fragment;
    private Context mContext;
    private ArrayList<CustomItemSearch> items;
    private int mLayout,mLayout1;
    int count_pro=1,numClick=0;
    int num=1,mCount=0;
    ...
    int total_price=0,totalCount=0,price=0;

    int count_pro_total = 0, price_total = 0,sum_num = 0;

    private GetIPAPI getIPAPI;

    public MyAdapterSearch(Context context, int layout, ArrayList<CustomItemSearch> arrayList, String dataID, int layout1, ListView listView, TextView text1, TextView text2,TextView text3) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            vHolder = new ViewHolderSearch(convertView);
            convertView.setTag(vHolder);

            v=inflater.inflate(mLayout1,parent,false);
        } else {
            vHolder = (ViewHolderSearch)convertView.getTag();
        }
        ...
        final CustomItemSearch item = items.get(position);
            ...
            public void onClick(View v) {
                ...
                okButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        mListview.setAdapter(MyAdapterSearch.this);
