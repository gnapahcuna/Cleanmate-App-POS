...
/**
 * Created by anucha on 5/12/2018.
 */
...
public class Converter {
    ...
    public Bitmap textAsBitmap(String text, float textSize, float stroke,
        ...
        StaticLayout staticLayout = new StaticLayout(text, 0, text.length(),
                paint, 400, android.text.Layout.Alignment.ALIGN_NORMAL, 1.0f,
                1.0f, false);

        int linecount = staticLayout.getLineCount();

        int height = (int) (baseline + paint.descent()-1) * linecount-1;

        Bitmap image = Bitmap
                .createBitmap(400, height, Bitmap.Config.ARGB_8888);
